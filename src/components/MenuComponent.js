            ...
            <div className="container mx-auto flex items-center justify-between px-4 py-6">
             ...
             <div className="flex items-center">
                <div className="relative">
                    <input  defaultValue="" className="bg-gray-800 rounded-full w-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-outline" placeholder="Search" />
