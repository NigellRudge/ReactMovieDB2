...
const  MenuComponent= function(props) {
    ...
    let trendStyle,showStyle,actorStyle;
    trendStyle = showStyle = actorStyle = "font-semibold hover:bg-red-1000 transition ease-in-out duration-150 rounded px-2 py-2 text-gray-100";
    switch(location.pathname){
        case "/shows":
            showStyle = "bg-red-1000 rounded px-2 py-2 mt-1 text-gray-100 font-semibold"
            break;
        case "/trending":
            trendStyle = "bg-red-1000 rounded px-2 py-2 mt-1 text-gray-100 font-semibold"
            break
        case "/":
            trendStyle = "bg-red-1000 rounded px-2 py-2 mt-1 text-gray-100 font-semibold"
            break
        case "/actors":
            actorStyle = "bg-red-1000 rounded px-2 py-2 mt-1 text-gray-100 font-semibold"
            break
    }
    return(
            ...
            <div className="container mx-auto flex items-center justify-between px-4 py-6">
             ...
             <div className="flex items-center">
                <div className="relative">
                    <input  defaultValue="" className="bg-gray-900 rounded-full w-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-outline" placeholder="Search" />
                    <div className="absolute top-0">
                        <svg className="fill-current w-4 text-gray-500 mt-2 ml-2" viewBox="0 0 24 24"><path className="heroicon-ui" d="M16.32 14.9l5.39 5.4a1 1 0 01-1.42 1.4l-5.38-5.38a8 8 0 111.41-1.41zM10 16a6 6 0 100-12 6 6 0 000 12z"/></svg>
                    </div>
                </div>
